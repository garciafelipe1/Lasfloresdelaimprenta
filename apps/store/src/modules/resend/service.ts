...
import { orderShippedEmail } from "./emails/shipment-created";
...
const templates: { [key in Templates]?: (props: unknown) => React.ReactNode } =
  {
    ...
    [Templates.PAYMENT_CAPTURED]: paymentCapturedEmail,
    [Templates.SHIPMENT_CREATED]: orderShippedEmail,
  };
...
class ResendNotificationProviderService extends AbstractNotificationProviderService {
  ...
  getTemplateSubject(template: Templates) {
    ...
    switch (template) {
      ...
      case Templates.PAYMENT_CAPTURED:
